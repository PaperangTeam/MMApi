...
- (void)loadDataWithDefaultType:(NSInteger)defaultType list:(NSArray<NSNumber *> * _Nonnull)list;
...
/// description
+ (void)hideAll;
@property (nonatomic, copy) void (^ _Nullable okClick)(enum PrintPreviewType);
@end
