 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `MBModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface MBAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation MBAuthor
     @end
 
     @interface MBBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) MBAuthor *author;
     @end
     ...
     int main() {
         ...
         MBBook *book = [MBBook mb_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book mb_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface MBShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation MBShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self mb_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self mb_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self mb_modelCopy]; }
     - (NSUInteger)hash { return [self mb_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self mb_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (MBModel)
 ...
 */
+ (nullable instancetype)mb_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "MBMB-MM-dd'T'HH:mm:ssZ", "MBMB-MM-dd HH:mm:ss" or "MBMB-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)mb_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)mb_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)mb_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)mb_modelToJSONObject;
 ...
 */
- (nullable NSData *)mb_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)mb_modelToJSONString;
 ...
 */
- (void)mb_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)mb_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)mb_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (MBModel)
 ...
 */
+ (nullable NSDictionary *)mb_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<MBModel>' to your class header.
 */
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class MBShadow, MBBorder, MBAttachment;
 
        @interface MBAttributes
        @property NSString *name;
        ...
        @implementation MBAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [MBShadow class],
                     @"borders" : MBBorder.class,
                     @"attachments" : @"MBAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class MBCircle, MBRectangle, MBLine;
 
        @implementation MBShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [MBCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [MBRectangle class];
